...
private:
    ...
    void initialize_motors() {
        // can0
        motors_.push_back(std::make_unique<Motor>(0x141, 100, 0, 30, 30.0f/4.0f));
        motors_.push_back(std::make_unique<Motor>(0x142, 100, 0, 30, 30.0f/4.0f));
        motors_.push_back(std::make_unique<Motor>(0x143, 100, 0, 50, 50.0f/6.7f));
        motors_.push_back(std::make_unique<Motor>(0x144, 100, 0, 50, 50.0f/6.7f));
        motors_.push_back(std::make_unique<Motor>(0x145, 100, 0, 8 , 4.0f/3.6f ));
        motors_.push_back(std::make_unique<Motor>(0x146, 100, 0, 8 , 4.0f/3.6f ));
        // can2
        motors_.push_back(std::make_unique<Motor>(0x151, 100, 0, 30, 30.0f/4.0f));
        motors_.push_back(std::make_unique<Motor>(0x152, 100, 0, 30, 30.0f/4.0f));
        motors_.push_back(std::make_unique<Motor>(0x153, 100, 0, 50, 50.0f/6.7f));
        motors_.push_back(std::make_unique<Motor>(0x154, 100, 0, 50, 50.0f/6.7f));
        motors_.push_back(std::make_unique<Motor>(0x155, 100, 0, 8 , 4.0f/3.6f ));
        motors_.push_back(std::make_unique<Motor>(0x156, 100, 0, 8 , 4.0f/3.6f ));
...
// 권한 부여 필요
// sudo setcap cap_net_raw,cap_sys_nice+eip $(find ~/mujoco_ws/install -type f -name motor_test3)
