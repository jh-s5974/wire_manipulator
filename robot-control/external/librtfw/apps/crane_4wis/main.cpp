...
#include "task_pool/wheel_task.h"
#include "task_pool/marker_tracker.h"
#include "task_pool/fourwheel_task.h"
...
int main(int argc, char** argv) {
    ...
    try {
        ...
        framework.registerTask(std::make_unique<task_pool::FK>(), 100, 1);
        framework.registerTask(std::make_unique<task_pool::IK>(), 100, 1);
        ...
        config.parameter_file_path = "crane4wis_parameters.yaml";
