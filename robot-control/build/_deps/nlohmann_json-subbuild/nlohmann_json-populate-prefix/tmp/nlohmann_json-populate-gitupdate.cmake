...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v3.11.3"
  WORKING_DIRECTORY "/home/jh/wire_manipulator/robot-control/build/_deps/nlohmann_json-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/jh/wire_manipulator/robot-control/build/_deps/nlohmann_json-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/jh/wire_manipulator/robot-control/build/_deps/nlohmann_json-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
